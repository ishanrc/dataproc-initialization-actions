...
class DrillTestCase(DataprocTestCase):
    ...
    @parameterized.expand([
        ...
        ("HA", "1.3", INIT_ACTION, [("m-0", "w-0", "ZOOKEEPER"), ("w-0", "m-1", "ZOOKEEPER")]),
