...
class JupyterTestCase(DataprocTestCase):
    COMPONENT = 'jupyter'
    INIT_ACTION = 'gs://dataproc-initialization-actions/jupyter/jupyter.sh'
    ...
    @parameterized.expand([
        ...
        ("SINGLE", "1.2", ["m"], "5.6.0"),
        ("STANDARD", "1.2", ["m"], "5.6.0"),
        ("HA", "1.2", ["m-0", "m-1", "m-2"], "5.6.0"),
        ("SINGLE", "1.3", ["m"], "5.6.0"),
        ("STANDARD", "1.3", ["m"], "5.6.0"),
        ("HA", "1.3", ["m-0", "m-1", "m-2"], "5.6.0"),
